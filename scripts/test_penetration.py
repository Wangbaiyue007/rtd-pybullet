...
fetch_env.load("../assets/objects/cube_small.urdf", [0, -0.5, 1.0 + 0.05*m.sqrt(2)], [m.pi/4, 0, 0])
fetch_env.load("../assets/objects/cube_small.urdf", [0, 0.5, 0.99 + 0.05*m.sqrt(2)], [m.pi/4, 0, 0])
fetch_env.load("../assets/objects/tray.urdf", [0, -0.5, 1], [m.pi/4, 0, 0])
fetch_env.load("../assets/objects/tray.urdf", [0, 0.5, 1], [m.pi/4, 0, 0])
