...
for step in range(30):
    ...
    observations, reward, done, info = env.step(ka, flag)
...
np.savetxt("../zonotope/data/zonopy_qpos.csv", qpos, delimiter=",")
np.savetxt("../zonotope/data/zonopy_qacc.csv", qacc, delimiter=",")
